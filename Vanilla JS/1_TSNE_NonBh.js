//Small TSNE when there is no need to implement an optimization;
function TSNE(X, DesiredPerplexity, numberOfIterations, numberOfDimentionsInLowDimensionalSpace, LearningRatio, Momentum){
    ...
    let y=zeros([numberOfSamplesInX-1,numberOfDimentionsInLowDimensionalSpace-1]);
    let oldy=zeros([numberOfSamplesInX-1,numberOfDimentionsInLowDimensionalSpace-1]);
    ...
    let p = SearchMeForFixedPerpexity(X, numberOfSamplesInX, numberOfDimentions, DesiredPerplexity);
    ...
    //end
    YUpload(p, y, oldy, numberOfSamplesInX, numberOfDimentionsInLowDimensionalSpace, 20, Momentum * 0.5, LearningRatio);
    YUpload(p, y, dCdYi, numberOfSamplesInX, numberOfDimentionsInLowDimensionalSpace, numberOfIterations - 20, Momentum, LearningRatio);
    return y;
}
